...
public class AppFuncionario {
	...
	protected void initialize() {
		...
		jpFuncLivros.setBounds(12, 13, 998, 519);
		...
		jpFuncConta.setBounds(0, 0, 998, 519);
		...
		// selec�ao do metodo de pagamento e aparecimento da respectiva janela

		comboBoxTipoPagamento.addItem("(escolha o m�todo de pagamento)");
