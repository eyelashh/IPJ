...
public class AppFuncionario implements Serializable {
	...
	String[] OpcoesPesquisaLIVRO = new String[] { "TÃ­tulo", "Autor", "Ano" };
...
//																					int nif = Integer.parseInt(listNifsClientes.getSelectedValue());
		...
		// criar um defaul model para guardar e fazer atualizaÃ§oes da lista
