...
public class AppFuncionario implements Serializable {
	...
	String[] OpcoesPesquisaLIVRO = new String[] { "T√≠tulo", "Autor", "Ano" };
	...
	String[] itens = new String[] { "Escolha o m√©todo de pagamento", "Dinheiro", "Multibanco" };
...
//																					int nif = Integer.parseInt(listNifsClientes.getSelectedValue());
																					...
																					JOptionPane.showMessageDialog(null,
																							"Seleccione um carrinho da lista");
																				}
																			}
																		});
																																		...
																																		if (!listNifsClientes.isSelectionEmpty()) {
																																			...
																																			if (novaQuantidadeINT >= antigaQuantidadeINT) {
																																				...
																																				if (gl.viewComics.adicionarAoCarrinhoPossivel(qtdAlterarCarrinhoSTR, idLivro, stock)) {
																																					...
																																					JOptionPane.showMessageDialog(null,
																																							"N„o foi possÌvel adicionar a quantidade desejada ao carrinho. Verifique o stock disponivel do livro em questao");
																																				}
		...
		tabelaLivros.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// a linha È actualizada para o caso de ter havido ordenacao
		...
		// criar um defaul model para guardar e fazer atualiza√ßoes da lista
